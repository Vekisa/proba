...
public class RegisteredUserController {
	...
	public ResponseEntity<List<Resource<RegisteredUser>>> getAllRegisteredUsers(Pageable pageable) {
		...
		if (registeredUsers.isEmpty())
			...
			return new ResponseEntity<List<Resource<RegisteredUser>>>(
					HATEOASImplementorUser.createRegisteredUserList(registeredUsers.getContent()), HttpStatus.OK);
	}

	// Kreiranje usera
	@RequestMapping(method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	@ApiOperation(value = "Kreira i memoriše usera.", notes = "Povratna vrednost servisa je sačuvan user.", httpMethod = "POST", consumes = "application/json", produces = "application/json")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = RegisteredUser.class),
			@ApiResponse(code = 204, message = "No Content"), @ApiResponse(code = 400, message = "Bad Request") })
	public ResponseEntity<Resource<RegisteredUser>> createUser(@Valid @RequestBody RegisteredUser registeredUser) {
		...
		return new ResponseEntity<Resource<RegisteredUser>>(
				HATEOASImplementorUser.createRegisteredUser(createdRegisteredUser), HttpStatus.CREATED);
	}
	...
	public ResponseEntity<Resource<RegisteredUser>> getRegisteredUserById(@PathVariable(value = "id") Long userId) {
		...
		if (registeredUser.isPresent())
			return new ResponseEntity<Resource<RegisteredUser>>(
					HATEOASImplementorUser.createRegisteredUser(registeredUser.get()), HttpStatus.OK);
		else
			return ResponseEntity.noContent().build();
	}
	...
	@ApiOperation(value = "Update hotela.", notes = "Ažurira usera sa zadatim ID-em na osnovu prosleđenog usera. Kolekcije originalnog usera ostaju netaknute.", httpMethod = "PUT", consumes = "application/json", produces = "application/json")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = RegisteredUser.class),
			@ApiResponse(code = 204, message = "No Content"), @ApiResponse(code = 400, message = "Bad Request") })
	public ResponseEntity<Resource<RegisteredUser>> updateUserWithId(@PathVariable(value = "id") Long userId,
		...
		if (oldRegisteredUser.isPresent()) {
			...
			return new ResponseEntity<Resource<RegisteredUser>>(
					HATEOASImplementorUser.createRegisteredUser(oldRegisteredUser.get()), HttpStatus.OK);
		} else {
			return ResponseEntity.notFound().build();
		}
	}
	...
	@ApiOperation(value = "Vraća rezervacije prosledjenog usera.", notes = "Povratna vrednost servisa je lista rezervacija.", httpMethod = "GET", produces = "application/json")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = List.class),
			@ApiResponse(code = 204, message = "No Content"), @ApiResponse(code = 400, message = "Bad Request") })
	public ResponseEntity<List<Resource<Reservation>>> getReservationsForUserWithId(
		...
		if (registeredUser.isPresent()) {
			...
			if (reservationList.isEmpty())
				...
				return new ResponseEntity<List<Resource<Reservation>>>(
						HATEOASImplementorUser.createReservationList(reservationList), HttpStatus.OK);
		} else {
			return ResponseEntity.notFound().build();
		}
	}
	...
	@ApiOperation(value = "Kreira rezervaciju za zadatog usera", notes = "Povratna vrednost metode je kreirana rezervacija.", httpMethod = "POST", produces = "application/json", consumes = "application/json")
	...
	public ResponseEntity<Resource<Reservation>> createReservationForUserWithId(@PathVariable(value = "id") Long userId,
		...
		if (registeredUser.isPresent()) {
			...
			return new ResponseEntity<Resource<Reservation>>(HATEOASImplementorUser.createReservation(reservation),
					HttpStatus.CREATED);
		} else {
			return ResponseEntity.notFound().build();
		}
	...
	@ApiOperation(value = "Vraća primljene zahteve prijateljstva prosledjenog usera.", notes = "Povratna vrednost servisa je lista zahteva.", httpMethod = "GET", produces = "application/json")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = List.class),
			@ApiResponse(code = 204, message = "No Content"), @ApiResponse(code = 400, message = "Bad Request") })
	public ResponseEntity<List<Resource<FriendRequest>>> getReceivedFriendRequestsForUserWithId(
			@PathVariable(value = "id") Long userId) {
		Optional<RegisteredUser> registeredUser = registeredUserRepository.findById(userId);
		if (registeredUser.isPresent()) {
			...
			if (requestsList.isEmpty())
				...
				return new ResponseEntity<List<Resource<FriendRequest>>>(
						HATEOASImplementorUser.createFriendRequestList(requestsList), HttpStatus.OK);
		} else {
			return ResponseEntity.notFound().build();
		}
	}
	...
	@ApiOperation(value = "Kreira zahtev prijateljstva za zadatog usera", notes = "Povratna vrednost metode je kreiran zahtev prijateljstva.", httpMethod = "POST", produces = "application/json", consumes = "application/json")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = FriendRequest.class),
			@ApiResponse(code = 204, message = "No Content"), @ApiResponse(code = 400, message = "Bad Request") })
	public ResponseEntity<Resource<FriendRequest>> createReceivedFriendRequestForUserWithId(
			@PathVariable(value = "id") Long userId, @Valid @RequestBody FriendRequest friendRequest) {
		Optional<RegisteredUser> registeredUser = registeredUserRepository.findById(userId);
		if (registeredUser.isPresent()) {
			registeredUser.get().addReceived(friendRequest);
			registeredUserRepository.save(registeredUser.get());
			return new ResponseEntity<Resource<FriendRequest>>(
					HATEOASImplementorUser.createFriendRequest(friendRequest), HttpStatus.CREATED);
		} else {
			return ResponseEntity.notFound().build();
		}
	}
	...
	@ApiOperation(value = "Vraća poslate zahteve prijateljstva prosledjenog usera.", notes = "Povratna vrednost servisa je lista zahteva.", httpMethod = "GET", produces = "application/json")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = List.class),
			@ApiResponse(code = 204, message = "No Content"), @ApiResponse(code = 400, message = "Bad Request") })
	public ResponseEntity<List<Resource<FriendRequest>>> getSentFriendRequestsForUserWithId(
			@PathVariable(value = "id") Long userId) {
		Optional<RegisteredUser> registeredUser = registeredUserRepository.findById(userId);
		if (registeredUser.isPresent()) {
	...
	@ApiOperation(value = "Kreira poslat zahtev prijateljstva za zadatog usera", notes = "Povratna vrednost metode je kreiran zahtev prijateljstva.", httpMethod = "POST", produces = "application/json", consumes = "application/json")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = FriendRequest.class),
			@ApiResponse(code = 204, message = "No Content"), @ApiResponse(code = 400, message = "Bad Request") })
	public ResponseEntity<Resource<FriendRequest>> createSentFriendRequestForUserWithId(
			@PathVariable(value = "id") Long userId, @Valid @RequestBody FriendRequest friendRequest) {
		Optional<RegisteredUser> registeredUser = registeredUserRepository.findById(userId);
		if (registeredUser.isPresent()) {
	...
	@ApiOperation(value = "Vraća prijateljstva prosledjenog usera.", notes = "Povratna vrednost servisa je lista prijateljstava.", httpMethod = "GET", produces = "application/json")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = List.class),
			@ApiResponse(code = 204, message = "No Content"), @ApiResponse(code = 400, message = "Bad Request") })
	public ResponseEntity<List<Resource<Friendship>>> getFriendshipsForUserWithId(
			@PathVariable(value = "id") Long userId) {
		Optional<RegisteredUser> registeredUser = registeredUserRepository.findById(userId);
		if (registeredUser.isPresent()) {
			...
			if (friendshipList.isEmpty())
				...
				return new ResponseEntity<List<Resource<Friendship>>>(
						HATEOASImplementorUser.createFriendshipList(friendshipList), HttpStatus.OK);
		} else {
			return ResponseEntity.notFound().build();
		}
	}
	...
	@ApiOperation(value = "Kreira prijateljstvo za zadatog usera", notes = "Povratna vrednost metode je kreirano prijateljstvo.", httpMethod = "POST", produces = "application/json", consumes = "application/json")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = Friendship.class),
			@ApiResponse(code = 204, message = "No Content"), @ApiResponse(code = 400, message = "Bad Request") })
	public ResponseEntity<Resource<Friendship>> createFriendshipForUserWithId(@PathVariable(value = "id") Long userId,
		...
		if (registeredUser.isPresent()) {
			...
			registeredUserRepository.save(registeredUser.get());
			return new ResponseEntity<Resource<Friendship>>(HATEOASImplementorUser.createFriendship(friendship),
					HttpStatus.CREATED);
		} else {
			return ResponseEntity.notFound().build();
		}
