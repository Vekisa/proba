...
public class FlightController {
	...
	public ResponseEntity<List<Resource<Flight>>> getAllFlights(Pageable pageable) {
		return new ResponseEntity<List<Resource<Flight>>>(HATEOASImplementor.createFlightsList(service.findAll(pageable)), HttpStatus.OK);
	}
	...
	public ResponseEntity<Resource<Flight>> getFlightById(@PathVariable("id") Long flightId) {
		return new ResponseEntity<Resource<Flight>>(HATEOASImplementor.createFlight(service.findById(flightId)), HttpStatus.OK);
	}
	...
	public ResponseEntity<Resource<Flight>> updateFlightWithId(@PathVariable("id") Long flightId, @Valid @RequestBody Flight newFlight) {
		return new ResponseEntity<Resource<Flight>>(HATEOASImplementor.createFlight(service.updateFlight(service.findById(flightId), newFlight)), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteFlightWithId(@PathVariable("id") Long flightId) {
		service.deleteFlight(service.findById(flightId));
	...
	public ResponseEntity<Resource<Flight>> setFinishDestinationForFlightWithId(@PathVariable("id") Long flightId, @RequestParam("destinationId") Long destinationId) {
		return new ResponseEntity<Resource<Flight>>(HATEOASImplementor.createFlight(service.setFinishDestinationForFlight(destinationId, service.findById(flightId))), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<Resource<FlightSeat>>> getFlightSeatsForFlightWithId(@PathVariable("id") Long flightId) {
		return new ResponseEntity<List<Resource<FlightSeat>>>(HATEOASImplementor.createFlightSeatsList(service.getSeatsForFlight(service.findById(flightId))), HttpStatus.OK);
	}
	...
	public ResponseEntity<Resource<Flight>> addSeatToRowForFlightWithId(@PathVariable("id") Long flightId, @RequestParam("row") int row) {
		return new ResponseEntity<Resource<Flight>>(HATEOASImplementor.createFlight(service.addSeatToRowForFlight(row, service.findById(flightId))), HttpStatus.CREATED);
	}
	...
	public ResponseEntity<List<Resource<Ticket>>> getTicketsForFlightWithId(@PathVariable("id") Long flightId) {
		return new ResponseEntity<List<Resource<Ticket>>>(HATEOASImplementor.createTicketsList(service.getTicketsForFlight(service.findById(flightId))), HttpStatus.OK);
	}
	...
	public ResponseEntity<Resource<Flight>> addConfigurationToFlightWithId(@PathVariable("id") Long flightId, @RequestParam("configId") Long configurationId) {
		return new ResponseEntity<Resource<Flight>>(HATEOASImplementor.createFlight(service.setConfigurationToFlight(configurationId, service.findById(flightId))), HttpStatus.OK);
	}
	...
	public ResponseEntity<Resource<Destination>> getStartDestinationForFlightWithId(@PathVariable("id") Long id) {
		return new ResponseEntity<Resource<Destination>>(HATEOASImplementor.createDestination(service.getStartDestinationOfFlight(service.findById(id))), HttpStatus.OK);
	}
	...
	public ResponseEntity<Resource<Destination>> getFinishDestinationForFlightWithId(@PathVariable("id") Long id) {
		return new ResponseEntity<Resource<Destination>>(HATEOASImplementor.createDestination(service.getFinishDestinationOfFlight(service.findById(id))), HttpStatus.OK);
	}
	...
	public ResponseEntity<Resource<FlightConfiguration>> getFlightConfigurationForFlightWithId(@PathVariable("id") Long id) {
		return new ResponseEntity<Resource<FlightConfiguration>>(HATEOASImplementor.createFlightConfiguration(service.getConfigurationOfFlight(service.findById(id))), HttpStatus.OK);
	}
