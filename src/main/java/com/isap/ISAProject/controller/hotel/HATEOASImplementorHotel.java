...
public class HATEOASImplementorHotel {
	...
	public static Resource<Hotel> createHotel(Hotel hotel) {
		...
		resource.add(linkTo(methodOn(HotelController.class).getAllHotels(null)).slash("?page=0&size=5").withRel("all_hotels"));
		resource.add(linkTo(methodOn(HotelController.class).getFloorsForHotelWithId(hotel.getId())).withRel("hotel_floors"));
		resource.add(linkTo(methodOn(HotelController.class).getExtraOptionsForHotelWithId(hotel.getId())).withRel("hotel_extra_options"));
	...
	public static Resource<Floor> createFloor(Floor floor){
		...
		resource.add(linkTo(methodOn(FloorController.class).getAllFloors(null)).slash("?page=0&size=5").withRel("all_floors"));
		resource.add(linkTo(methodOn(FloorController.class).getRoomsForFloorWithId(floor.getId())).withRel("floor_rooms"));
	...
	public static Resource<ExtraOption> createExtraOption(ExtraOption extraOption){
		...
		resource.add(linkTo(methodOn(ExtraOptionController.class).getAllExtraOptions(null)).slash("?page=0&size=5").withRel("all_extra_options"));
		resource.add(linkTo(methodOn(ExtraOptionController.class).getHotelForExtraOptionWithId(extraOption.getId())).withRel("hotel"));
		resource.add(linkTo(methodOn(ExtraOptionController.class).getRoomReservationForExtraOptionWithId(extraOption.getId())).withRel("room_reservation"));
		return resource;
	}
	...
	public static Resource<Catalogue> createCatalogue(Catalogue catalogue){
		...
		resource.add(linkTo(methodOn(CatalogueController.class).getAllCatalogues(null)).slash("?page=0&size=5").withRel("all_catalogues"));
		resource.add(linkTo(methodOn(CatalogueController.class).getRoomTypesForCatalogueWithId(catalogue.getId())).withRel("catalogue_room_types"));
	...
	public static Resource<Room> createRoom(Room room){
		...
		resource.add(linkTo(methodOn(RoomController.class).getAllRooms(null)).slash("?page=0&size=5").withRel("all_rooms"));
		resource.add(linkTo(methodOn(RoomController.class).getRoomReservationsForRoomWithId(room.getId())).withRel("room_reservations"));
		...
		resource.add(linkTo(methodOn(RoomController.class).getRoomTypeForRoomWithId(room.getId())).withRel("room_type"));
		return resource;
	}
	...
	public static Resource<RoomReservation> createRoomReservation(RoomReservation roomReservation){
		...
		resource.add(linkTo(methodOn(RoomReservationController.class).getAllRoomReservations(null)).slash("?page=0&size=5").withRel("all_room_reservations"));
		resource.add(linkTo(methodOn(RoomReservationController.class).getExtraOptionsForRoomReservationWithId(roomReservation.getId())).withRel("room_reservations_extra_options"));
	...
	public static Resource<RoomType> createRoomType(RoomType roomType){
		...
		resource.add(linkTo(methodOn(RoomTypeController.class).getAllRoomTypes(null)).slash("?page=0&size=5").withRel("all_room_types"));
