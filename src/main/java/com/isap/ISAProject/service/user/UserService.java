...
public class UserService implements UserServiceInterface {
	...
	private void checkIfUsernameExists(String username) {
		if (companyAdminsRepository.findByUsername(username) != null)
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Username already in use.");
		if (usersAdminsRepository.findByUsername(username) != null)
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Username already in use.");
		if (registeredUsersRepository.findByUsername(username) != null)
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Username already in use.");
	}

	private void checkIfEmailExists(String email) {
		if (companyAdminsRepository.findByEmail(email) != null)
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "E-mail already in use.");
		if (usersAdminsRepository.findByEmail(email) != null)
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "E-mail already in use.");
		if (registeredUsersRepository.findByEmail(email) != null)
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "E-mail already in use.");
	}
